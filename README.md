...
- Обновлять и редактировать свои вишлисты
...
- **Обновление** - редактирование информации о подарках
...
- **База данных**: http://localhost:3306
...
#### Обновление вишлиста (требует авторизацию)
```http
PUT /wishlist/update
Authorization: Bearer <token>
Content-Type: application/json
...
{
  "wishListId": 1,
  "gift": "Обновленное название подарка",
...
- Валидация URL и числовых значений
